...
async def start(event):
    ...
    await event.reply(
        ...
        buttons=[
            ...
            [
                Button.url("SOURCE CODE", url="github.com/harshkerw/CompressorBot"),
                Button.url("DEVELOPER", url="t.me/karitik_official"),
            ],
        ],
    )
...
async def beck(event):
    ...
    await event.edit(
        ...
        buttons=[
            [Button.inline("HELP", data="ihelp")],
            [
                Button.url("SOURCE CODE", url="github.com/harshkerw/"),
                Button.url("DEVELOPER", url="t.me/karitik_official"),
            ],
        ],
    )
